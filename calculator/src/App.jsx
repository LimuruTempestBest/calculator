...
const App = () => {
  ...
  return (
    <themeContext.Provider value={{ theme, toggleTheme }}>
      ...
      <div className='flex justify-center items-center w-full h-screen bg-purple-300 overflow-hidden ' id={theme}>
        ...
        <div className=' calculator-body bg-slate-100 p-10 w-80 md:w-96 rounded calculator-shadow z-[900] animate__animated animate__zoomInDown' id={theme}>
          ...
          <div className='flex flex-row items-center justify-between'>
            ...
            <div className='flex gap-2 items-center translate-x-1/2 -translate-y-1/2  '>
              <div className="w-8 h-1 rounded-full bg-stone-900 text">
              </div>
              <div className="w-1.5 h-1.5 rounded-full bg-stone-900 text">
              </div>
            </div>

            <div className='flex flex-row gap-2 text-zinc-500 text'>
